...
resource "aws_instance" "my_instance" {
  ...
  user_data                   = <<-EOF
              ...
              JS_FILE="a10-KwaziW117/frontend/src/play.js"  # Update with the path to your JavaScript file
              ...
              CONFIG_FILE="a10-KwaziW117/frontend/src/config.json"
